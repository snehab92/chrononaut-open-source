...
import { getQuestionsForType, type AssessmentQuestions } from "@/lib/assessments/questions";
...
const ASSESSMENT_CONFIGS: Record<AssessmentType, AssessmentConfig> = {
  ...
  strengths: {
    ...
    description: '60 strengths across 5 families - rate each on Performance, Energy, and Frequency',
    icon: Star,
    color: 'text-purple-600',
    bgColor: 'bg-purple-100',
    totalQuestions: 60,
    instructions: [
      'Based on the Cappfinity Strengths Profile, this maps 60 strengths across 5 families.',
      'For each strength, you\'ll rate three dimensions:',
      '• Performance: How well you do this (1-5)',
      '• Energy: How energizing it is for you (1-5)',
      '• Frequency: How often you use it (1-5)',
      'These ratings determine which quadrant each strength falls into: Realized, Unrealized, Learned, or Weakness.',
    ],
  },
  values_alignment: {
      ...
      <div className="p-4 rounded-lg bg-[#F5F0E6]">
        ...
        <div className="grid grid-cols-7 gap-2">
          {Array.from({ length: totalQuestions }).map((_, i) => {
            ...
            const hasAnswer = response !== undefined;
