...
const ASSESSMENT_TYPES = [
  ...
  { value: "strengths", label: "Professional Strengths" },
];

// Auto-detection keyword mappings for assessments
const ASSESSMENT_KEYWORDS: Record<string, string[]> = {
  self_compassion: ["self-compassion", "self compassion", "resilience"],
  values_alignment: ["values", "alignment", "core values"],
  executive_function: ["executive function", "ef", "productivity"],
  strengths: ["strengths", "professional strengths", "domains"],
};
