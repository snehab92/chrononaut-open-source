        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-1">
            ...
            <div className="flex items-center gap-1.5 px-2 py-1 rounded bg-green-50 border border-green-200">
              ...
              <span className="text-[10px] text-green-700">Strengths</span>
            </div>
            ...
            <div className="flex items-center gap-1.5 px-2 py-1 rounded bg-blue-50 border border-blue-200">
              ...
              <span className="text-[10px] text-blue-700">Growth</span>
            </div>
            ...
            <div className="flex items-center gap-1.5 px-2 py-1 rounded bg-gray-50 border border-gray-200">
              ...
              <span className="text-[10px] text-gray-700">Delegate</span>
            </div>
          </div>

          <p className="text-xs text-[#8B9A8F]">
            {counts.realized} strengths · {counts.learned} learned
          </p>
        </div>
      ) : (
        <div>
          <p className="text-sm text-[#8B9A8F] mb-2">
            Rate 16 skills on Proficiency & Energy
          </p>
