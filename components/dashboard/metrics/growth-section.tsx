...
function StrengthsModalContent({ data }: { data: StrengthsResult | null | undefined }) {
  ...
  const quadrantConfig = [
    { key: 'top_realized' as const, label: 'Realized Strengths', color: 'green', desc: 'Use these daily', count: data.quadrant_counts.realized },
    { key: 'top_unrealized' as const, label: 'Unrealized Potential', color: 'blue', desc: 'Develop these', count: data.quadrant_counts.unrealized },
    { key: 'top_learned' as const, label: 'Learned Behaviors', color: 'yellow', desc: 'Watch for overuse', count: data.quadrant_counts.learned },
    { key: 'top_weakness' as const, label: 'Weaknesses', color: 'red', desc: 'Minimize time here', count: data.quadrant_counts.weakness },
  ];
