...
export interface StrengthsQuadrants {
  realized: string[];     // Strengths you use and energize you
  unrealized: string[];   // Potential not yet developed
  learned: string[];      // Good at but draining (STRESS INDICATOR)
  weakness: string[];     // Neither skilled nor energizing
}
...
export interface ExecutiveFunctionData extends BaseAssessmentData {
  ...
  total_score: number | null;  // Max 210 (10 skills * 21)
