...
import { SONNET_MODEL, HAIKU_MODEL } from "@/lib/ai/model-selector";
...
- **Professional Skills:** Suggest leveraging Realized strengths for tasks. Warn if they're taking on work that relies heavily on Weakness areas. Note when they might be defaulting to energy-draining Learned behaviors.
...
- **Professional Skills:** Celebrate use of Realized strengths. If they seem stressed, check if they're overusing Learned behaviors (things they're good at but drain them).
