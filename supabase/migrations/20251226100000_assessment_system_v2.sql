...
-- 2. Strengths responses (32 strengths × 3 dimensions)
...
-- ============================================================================
-- Executive function assessment has 12 skills (1-7 scale each, max total 84)
...
-- Update max_possible constraint (DB allows up to 252 for backwards compat, new assessments max at 84)
ALTER TABLE executive_function_scores
...
-- 6 dimensions: 3 positive (higher = better), 3 negative (lower = better)
...
-- STRENGTHS RESPONSES
-- ============================================================================
-- Professional strengths (32 strengths × 3 dimensions)
